...
int main(void)
{
    ...
    register int y_first, x_first;
    // For each 16x16 block in first image
    for (x_first = 0; x_first < 20; x_first++)
    {
        register int x_first_pixel = x_first * 16;
        for (y_first = 0; y_first < 15; y_first++)
        { 
            register int y_first_pixel = y_first * 16;
            ...
            {
                register int x_second_pixel = x_second * 16;
                for (y_second = 0; y_second < 15; y_second++)
                {
                    register int y_second_pixel = y_second * 16;
